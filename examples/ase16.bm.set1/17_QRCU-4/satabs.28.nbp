...
decl b3_1_eq_readerprogress1;  // 1 == readerprogress1
decl b5_0_eq_NONDET;           // 0 == NONDET
...
decl b4_1_eq_readerstart1;  // LOCAL -- 1 == readerstart1
decl b6_sum_le_1;           // LOCAL -- sum <= 1
...
b1:=*;
b2_FALSE_eq_MTX:=*;
b3_1_eq_readerprogress1:=*;
b5_0_eq_NONDET:=*;

0: skip; // location only

// file ./cav16.bm/17_QRCU-4/main.c line 17
1: b3_1_eq_readerprogress1 := 0;
// TO Predicates: b3_1_eq_readerprogress1
...
22: if b5_0_eq_NONDET then goto 36; fi;
...
//l4:
36: if b5_0_eq_NONDET then goto 50; fi;
...
75: if b5_0_eq_NONDET then goto 152; fi;
...
//l12:
89: if b5_0_eq_NONDET then goto 153; fi;
...
128: if b5_0_eq_NONDET then goto 180; fi;
...
//l20:
142: if b5_0_eq_NONDET then goto 181; fi;
...
// file ./cav16.bm/17_QRCU-4/main.c line 193 function qrcu_reader3
153: b0,b1,b2_FALSE_eq_MTX := b1,*,* constrain
((!b0) | (!'b0)) &
((!b0) | 'b1);
// TO Predicates: b0 b1 b2_FALSE_eq_MTX
...
// file ./cav16.bm/17_QRCU-4/main.c line 208 function qrcu_reader3
170: b0,b1,b2_FALSE_eq_MTX := b1,*,* constrain
((!b0) | 'b1);
// TO Predicates: b0 b1 b2_FALSE_eq_MTX
...
179: b4_1_eq_readerstart1 := *;
// TO Predicates: b4_1_eq_readerstart1
...
// file ./cav16.bm/17_QRCU-4/main.c line 89 function qrcu_updater
199: b0,b1,b2_FALSE_eq_MTX := b1,*,* constrain
((!'b0) | (!'b2_FALSE_eq_MTX)) &
((!b0) | 'b1) &
((!'b0) | (!'b1));
// TO Predicates: b0 b1 b2_FALSE_eq_MTX
...
202: b4_1_eq_readerstart1 := b3_1_eq_readerprogress1;
// TO Predicates: b4_1_eq_readerstart1
...
// file ./cav16.bm/17_QRCU-4/main.c line 93 function qrcu_updater
207: b0,b1,b2_FALSE_eq_MTX := b1,*,* constrain
((!b0) | 'b1) &
((!b0) | (!'b0));
// TO Predicates: b0 b1 b2_FALSE_eq_MTX
...
209: if b5_0_eq_NONDET then goto 187; fi;
...
//l28:
215: if !b6_sum_le_1 then goto 200; fi;

216: if b5_0_eq_NONDET then goto 189; fi;
...
// FROM Predicates: b6_sum_le_1
//l30:
222: if b6_sum_le_1 then goto 245; fi;
...
// file ./cav16.bm/17_QRCU-4/main.c line 109 function qrcu_updater
247: b0,b1,b2_FALSE_eq_MTX := b1,*,* constrain
('b0 | 'b1) &
((!'b0) | (!'b2_FALSE_eq_MTX)) &
((!b0) | (!'b0));
// TO Predicates: b0 b1 b2_FALSE_eq_MTX
...
// FROM Predicates: b5_0_eq_NONDET
250: if b5_0_eq_NONDET then goto 255; fi;

// file ./cav16.bm/17_QRCU-4/main.c line 111 function qrcu_updater
// FROM Predicates: b4_1_eq_readerstart1
251: assume(b4_1_eq_readerstart1);

// file ./cav16.bm/17_QRCU-4/main.c line 112 function qrcu_updater
// FROM Predicates: b3_1_eq_readerprogress1
252: assume(b3_1_eq_readerprogress1);
...
//l38:
255: if b5_0_eq_NONDET then goto 260; fi;
...
//l39:
260: if b5_0_eq_NONDET then goto 360; fi;
